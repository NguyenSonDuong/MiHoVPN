...
class TermsViewModel(private val appDatabase: AppDatabase): ViewModel() {
    ...
    val termsText = """
        The following Terms and Conditions (“T&C”) govern the use of the MiHo VPN Free open source software platform (“MinhHoang Platform”) and MiHo VPN Free (the “Software”). Prior to any use of the MiHo VPN Free Platform, the User confirms to understand and expressly agrees to all of the Terms.

MiHo VPN Free is an Open Source software that enables you (the “Client”) to use the internet connection and resources of our contributors (the “Nodes”) for your private browsing using MiHo VPN Free Platform.

The MiHo VPN Free Platform rests on open-source software. This is an experimental version of the MiHo VPN Free Platform, and there is a risk that the NetSys Inc. (“Network Operator”) or other third parties not directly affiliated with the Network Operator, might unintentionally introduce weaknesses or bugs into the core infrastructural elements of the MiHo VPN Free Platform or Software causing the system to lose cryptocurrency stored in one or more Client accounts or other accounts or lose sums of other valued tokens issued on the MiHo VPN Free Platform, or causing to suffer other losses, inconvenience, or damage to its users. The user expressly knows and agrees that the user is using the MiHo VPN Free Platform and MiHo VPN Free software at the user’s sole risk.

These terms and conditions constitute an agreement between you and Network Operator and governs your access and use of MiHo VPN Free software and private browsing services provided by MiHo VPN Free Platform (the “Services”).

The Network Operator or other creators of the MiHo VPN Free Platform are entitled to discontinue this project at any time without any further explanation or prior notification at this experimental stage.
...
Before starting to use the Services, you must download MiHo VPN Free software and create an account entering your credentials and private/public keys. You hereby agree to provide true, accurate, current and complete information as may be prompted by any registration forms regarding your registration or use of Services.
...
NETWORK OPERATOR, ITS OWNERS, EMPLOYEES, AGENTS AND OTHERS THAT ARE INVOLVED WITH THE NETWORK OPERATOR ARE NOT IN ANY WAY OR FORM LIABLE FOR ANY HARM OF ANY SORT EXECUTED OR NOT EXECUTED, RESULTING FROM OR ARISING THROUGH OR FROM THE USE OF ANY ACCOUNT REGISTERED USING VPN Free Platform.
...
In order to maintain the Services and to ensure the proper functioning of VPN Free Platform, the Network Operator does collect limited and anonymized personal user information and site performance data (see section “Privacy Policy” for more details).

<h4>Data Privacy</h4>

Network Operator is committed to your privacy and does not collect, log, organize, structure, store, use, disseminate or make otherwise available any personal data of the Clients, e.g. Client’s identity, IP address, browsing history, traffic destination, data content, DNS queries from the Clients connected to VPN Free Platform Network, or any other personal information which could be considered personal data (i.e. any information relating to an identified or identifiable natural person).
Network Operator will collect anonymous statistics to improve the performance of VPN Free Platform Network. This information is fully anonymized and cannot be tied back to any individual users.
...
altered versions must be plainly marked as such, and must not be misrepresented as being the original Software or any other creation of Network Operator, or the product created under any commission of VPN Free Platform Platform;
...
Network Operator and VPN Free Platform logos and trademarks owned by us or our licensors, and no right, license, or interest in any such trademarks is granted hereunder. We respect the intellectual property of others, and we ask you to do the same. It is important (and a condition of these T&C) that you comply with all copyright laws and other provisions in connection with any content agreement to which you may be a party through the Services.
...
BY USING THE SERVICES YOU FULLY UNDERSTAND AND AGREE THAT IS AN EXPERIMENTAL VERSION OF THE VPN Free Platform PLATFORM, AND THERE IS A RISK THAT THE NETWORK OPERATOR OR OTHER THIRD PARTIES NOT DIRECTLY AFFILIATED WITH THE NETWORK OPERATOR, MAY INTRODUCE WEAKNESSES OR BUGS INTO THE CORE INFRASTRUCTURAL ELEMENTS OF THE VPN Free Platform PLATFORM CAUSING THE SYSTEM TO LOSE CRYPTOCURRENCY STORED IN ONE OR MORE CLIENT ACCOUNTS OR OTHER ACCOUNTS OR LOSE SUMS OF OTHER VALUED TOKENS ISSUED ON THE VPN Free Platform PLATFORM, OR CAUSING TO SUFFER OTHER LOSSES, INCONVENIENCE, OR DAMAGE TO ITS USERS.
...
By logging in to VPN Free Platform and using the Services, you agree to the T&C, including all other policies incorporated by reference.
...
For any questions you may contact us: <b>contact@kodlite.com</b>

Last update: <b>29-09-2019</b>
    """.trimIndent()
}